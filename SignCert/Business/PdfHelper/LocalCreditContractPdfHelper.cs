...
namespace SignCert.Business.PdfHelper
{
    ...
    /// </summary>
    internal class LocalCreditContractPdfHelper : BasePdfHelper
    {
        /// <summary>
        ///     平台服务公司
        /// </summary>
        ...
        public LocalCreditContractPdfHelper(LoanPdfModel model)
        {
            _model = model;
        ...
        private void BuildPdf()
        {
            ...
            memberList.Add(
                ...
                //    Msyh10BolderUnderLine));
                new Chunk(
                    (_model.LoanInfo.MemberName).PadRight(18),
                    Msyh10BolderUnderLine));


            memberList.Add(new Chunk("".PadRight(6), Msyh10Bold));
            memberList.Add(new Chunk("身份证/执照号：", Msyh10Bold));
            memberList.Add(
                //new Chunk(
                ...
                new Chunk(
                    (_model.MemberInfo.IdentityCard).PadRight(32), Msyh10BolderUnderLine));
            ...
            memberThird.Add(new Chunk("440301107195692", Msyh10));
            ...
            memberFourth.Add(new Chunk("营业执照号: ", Msyh10Bold));
            ...
            contentComment.Add(new ListItem(new Phrase(
                                                "1.甲方因日常运营资金周转需要，拟寻求资金支持；乙方因合法拥有资金，决定通过一定的投资渠道投资，实现资金保值增值；" +
                                                "丙方通过自行创立的投融资中介服务平台（网址：www.rjb777.com，下称“融金宝”）" +
                                                "能获取大量的投融资信息，并能有效提供投融资居间撮合、管理等服务。", Msyh8)));
            contentComment.Add(new ListItem(new Phrase(
                                                "2.乙方同意接受深圳市金信联融资担保有限公司为借款用户向乙方提供保证担保，" +
                                                "以确保借款用户因通过融金宝网站向出借人借款而形成的有关债权的实现，为此就保证人向出借人提供保证担保事宜。", Msyh8)));
            contentComment.Add(new ListItem(new Phrase("基于以上，四方本着实事求是、平等互利、真诚合作、共同发展的原则，就甲方通过丙方向乙方申请借款，丁方提供担保事宜，经过友好协商，达成协议如下：", Msyh8)));
            ...
            contentComment1.Add(new ListItem(new Phrase(
                                                 "（二）借款期限：自 " + _model.LoanInfo.ReviewTime.ToString("yyyy年MM月dd日") + "至 "
                                                 +
            ...
            contentComment1.Add(new ListItem(new Phrase(
                                                 ...
                                                 Msyh8)));
            contentComment1.Add(new ListItem(new Phrase(
                                                 "（借款利率的折算：日利率=年利率/365，月利率=年利率/12）", Msyh8)));
            contentComment1.Add(new ListItem(new Phrase(
                                                 "（四）借款用途：本合同项下借款用于" + _model.LoanInfo.LoanUseName, Msyh8)));
            ...
            contentComment2.Add(
                new ListItem(
                    new Phrase(
                        "（一）甲方采用以下第 " + _model.LoanInfo.RepaymentMethod.ToString(CultureInfo.InvariantCulture) +
                        " 种方式向乙方还款：", Msyh8)));
            ...
            contentComment2.Add(new ListItem(new Phrase("（三）乙方收到的还款，应依次偿还先前期后当期的如下费用：", Msyh8)));
            var contentComment23 = new List(false, 10);
            contentComment23.Add(new ListItem(new Phrase("1、依法及约定的应当支付的费用；", Msyh8)));
            contentComment23.Add(new ListItem(new Phrase("2、违约金（包括但不限于逾期还款违约金、提前还款违约金等）、罚息；", Msyh8)));
            contentComment23.Add(new ListItem(new Phrase("3、利息；", Msyh8)));
            contentComment23.Add(new ListItem(new Phrase("4、丙方平台借款管理费；", Msyh8)));
            contentComment23.Add(new ListItem(new Phrase("5、居间服务费；", Msyh8)));
            contentComment23.Add(new ListItem(new Phrase("6、担保服务费；", Msyh8)));
            contentComment23.Add(new ListItem(new Phrase("7、本金。", Msyh8)));
            ...
            contentComment3.Add(new ListItem(new Phrase("1、甲方提前偿还全部借款的，应支付两天的利息作为提前还款违约金。" +
                                                        "但甲方在还款期限届满日（含当日）前15天还款，乙方同意不收取违约金。", Msyh8)));
            contentComment3.Add(new ListItem(new Phrase("2、若丙方另行公布的借款规则中对提前还款违约金另行约定的，各方同意以另行公布的借款规则为准。", Msyh8)));
            ...
            contentComment4.Add(new ListItem(new Phrase("（一）还款日24时前，甲方未足额支付应付款项的，则视为逾期。", Msyh8)));
            contentComment4.Add(new ListItem(new Phrase("（二）甲方逾期的，乙方有权在约定利息之外另行加收逾期还款违约金及催收费用，" +
            ...
            content7.Add(new Chunk("第十条 各方权利义务", Msyh10Bold));
            var contentComment7 = new List(false, 10);
            contentComment7.Add(new ListItem(new Phrase("（一）甲方权利义务", Msyh8)));
            var contentComment71 = new List(false, 10);
            contentComment71.Add(new ListItem(new Phrase("1、有权向乙方申请借款；", Msyh8)));
            contentComment71.Add(new ListItem(new Phrase("2、应按丙方要求提供相关资料，确保所提供资料是真实、完整、有效的；", Msyh8)));
            contentComment71.Add(new ListItem(new Phrase("3、应接受乙方、丙方对其使用借款资金情况和其财务情况的监督；", Msyh8)));
            contentComment71.Add(new ListItem(new Phrase("4、应按约定按时足额偿还借款本金和利息、支付约定的相关费用；", Msyh8)));
            contentComment71.Add(new ListItem(new Phrase("5、必须按本合同约定的用途使用借款，并保证不利用本合同项下借款从事违反国家法律法规的非法活动；", Msyh8)));
            contentComment71.Add(new ListItem(new Phrase("6、有如下任何信息或情形变动、发生时，有义务于5日内通知乙方、丙方：" +
                                                         "住所、联系方式、涉及重大诉讼及其它有损还款能力事宜、（法人）发生隶属关系变更、经营范围改变、" +
                                                         "高管变动、组织架构调整、重大违纪违法或被索赔事件、经营困难、财务状况恶化、债权债务纠纷、其他可能影响偿债能力的事宜。",
                                                         Msyh8)));
            contentComment71.Add(new ListItem(new Phrase("7、出现如下情形的，应通知乙方、丙方并取得其同意：" +
                                                         "为他人提供担保、再次向第三方借款、处置名下重大资产、（法人）发生对外投资及资产转让的重大事项、" +
                                                         "股权调整或股权转让等、减少注册资本、进行分立、合并、重组、股份制改造等重大体制变更或撤销、解散、停业等。", Msyh8)));
            contentComment71.Add(new ListItem(new Phrase("8、授权丙方指定一名出借人，以甲方为借款人、丁方作为担保人将本合同项下的借款信息录入中国人民银行个人征信查询系统。", Msyh8)));
            contentComment7.Add(contentComment71);

            contentComment7.Add(new ListItem(new Phrase("（二）乙方权利义务", Msyh8)));
            var contentComment72 = new List(false, 10);
            contentComment72.Add(new ListItem(new Phrase("1、有权委托丙方了解甲方的个人资信状况和经济状况，要求甲方提供与本合同项下借款使用有关的资料。", Msyh8)));
            contentComment72.Add(new ListItem(new Phrase("2、授权丙方指定一名出借人，以甲方为借款人、丁方作为担保人将本合同项下的借款信息录入中国人民银行个人征信查询系统。", Msyh8)));
            contentComment72.Add(new ListItem(new Phrase("3、有权委托丙方通过资料分析、查验或现场调查等方式监督或检查甲方对借款的使用。", Msyh8)));
            contentComment72.Add(new ListItem(new Phrase("4、有权委托丙方通过向甲方在融金宝平台的电子信箱发送催收'站内信'、在公众媒体上发布催收公告或通过快递催收信函的方式对甲方进行催收通知。", Msyh8)));
            contentComment72.Add(new ListItem(new Phrase("5、有权按照本合同和融金宝平台的规定，在甲方发生还款逾期并达到相关借款规则规定期限时，在履行相关手续之后，获得丁方的垫付（担保代偿）。", Msyh8)));
            contentComment72.Add(new ListItem(new Phrase("6、应当对甲方的个人信息保密，但本合同另有规定的或为实现债权等必要情况下除外。", Msyh8)));
            contentComment7.Add(contentComment72);

            contentComment7.Add(new ListItem(new Phrase("（三）丙方权利义务", Msyh8)));
            var contentComment73 = new List(false, 10);
            contentComment73.Add(new ListItem(new Phrase("1、丙方根据甲、乙方的授权，通过融金宝平台，为甲、乙双方提供对接、撮合、资金监管等服务。", Msyh8)));
            contentComment73.Add(new ListItem(new Phrase("2、接受乙方委托，有权代乙方指定一名出借人与借款人在线下签署相关合同，并办理相关的抵押、质押等担保手续。", Msyh8)));
            contentComment73.Add(new ListItem(new Phrase("3、有权向甲、乙方收取相关费用，费用标准根据融金宝平台规则计收。", Msyh8)));
            contentComment7.Add(contentComment73);

            contentComment7.Add(new ListItem(new Phrase("（四）丁方权利义务", Msyh8)));
            var contentComment74 = new List(false, 10);
            contentComment74.Add(
                new ListItem(new Phrase("1、丁方在甲方借款发生逾期之日起10个工作日内，在履行相关手续之后，应代甲方向乙方偿付符合融金宝平台规则及本合同约定的本息。", Msyh8)));
            contentComment74.Add(
                new ListItem(new Phrase("2、丁方自代偿完成之时，乙方享有的债权转让给丁方享有。该债权转让可通过融金宝平台的站内信或绑定的电子邮件进行通知，各方认可此种通 知为有效合法。", Msyh8)));
            contentComment74.Add(
                new ListItem(new Phrase("3、丁方有权在发生逾期时，采取合理合法的手段进行催收，包括但不限于通过站内信、电子邮件、公共媒体公告等方式，各方对此予以认可。", Msyh8)));
            ...
            contentComment8.Add(new ListItem(new Phrase("1、甲方提供虚假、伪造的申请材料，或进行虚假陈述；", Msyh8)));
            contentComment8.Add(new ListItem(new Phrase("2、甲方未按合同约定用途使用借款；", Msyh8)));
            contentComment8.Add(new ListItem(new Phrase("3、甲方未按合同约定偿还或支付到期本金、利息、费用及其他任何应付款项；", Msyh8)));
            contentComment8.Add(new ListItem(new Phrase("4、违反本合同规定的甲方的义务；", Msyh8)));
            contentComment8.Add(new ListItem(new Phrase("5、甲方拒不配合乙、丙方对其借款使用情况和经营情况进行的监督和调查；", Msyh8)));
            contentComment8.Add(new ListItem(new Phrase("6、甲方为逃避债务，恶意转移资产或放弃、减免对第三方的债权；无法清偿第三方到期债务；", Msyh8)));
            contentComment8.Add(new ListItem(new Phrase("7、其它足以让甲方认为危及本合同项下债权安全的其他情况；", Msyh8)));
            ...
            contentComment9.Add(new ListItem(new Phrase("1、要求限期改正；", Msyh8)));
            contentComment9.Add(new ListItem(new Phrase("2、宣布本合同项下的借款本息全部立即到期，要求立即偿还全部借款本息、违约金及其他各项应付费用等；", Msyh8)));
            contentComment9.Add(new ListItem(new Phrase("3、解除本合同；", Msyh8)));
            ...
            var contentComment10 = new List(false, 10);
            contentComment10.Add(
                new ListItem(new Phrase("各方保证，对讨论、签订、履行本协议过程中所获悉的属于其他方的且无法自公开渠道获得的文件和资料（包括但不限 于个人隐私、商业计划、运营资金、财务信息等）予以保密。" +
                           "否则，应承担相应的违约责任并赔偿由此造成的全部损失。", Msyh8)));
            content10.Add(contentComment10);
            ...
            var contentComment11 = new List(false, 10);
            contentComment11.Add(
                new ListItem(new Phrase("本协议适用中华人民共和国法律和法规，各方权益受中华人民共和国法律保障。因本协议发生纠纷，各方协商解决；协商不成时，任何一方可向本协议签订地有管辖权人民法院提出诉讼。", Msyh8)));
            content11.Add(contentComment11);
            ...
            var contentComment12 = new List(false, 10);
            contentComment12.Add(new ListItem(new Phrase("（一）各方在此再次重申，各方已经全面、完整和准确地理解了本协议全部条款的内容，并愿意接受本协议的约束。", Msyh8)));
            contentComment12.Add(new ListItem(new Phrase("（二）各方确认并同意，基于保障资金安全及实现债权的需要，各方另行签署的相关协议亦具有独立的法律效力。", Msyh8)));
            contentComment12.Add(new ListItem(new Phrase("（三）各方确认，各方自行保管在丙方提供的融金宝平台注册的账户信息及密码，同时该账户为各自资金管理账户。" +
                                                            "若有遗失，应及时书面通知丙方。各方承诺自行操作自己的账户，由此所产生的一切后果自行承担。", Msyh8)));
            contentComment12.Add(new ListItem(new Phrase("（四）本协议采用数据电文形式，自各方网上签署确认之日起生效。各方确认该数据电文协议具有法律认可的效力。", Msyh8)));
            content12.Add(contentComment12);
            myDocument.Add(content12);
            myDocument.Add(NewLine);

            //13.合同正文第十三条
            var content13 = new Paragraph { Alignment = Element.ALIGN_LEFT };
            content13.Add(new Chunk("第十三条 其他", Msyh10Bold));
            content13.Add(new Chunk(Environment.NewLine));
            var contentComment13 = new List(false, 10);
            contentComment13.Add(
                new ListItem(new Phrase("甲方需就其在本合同项下的借款向丙方、丁方支付借款管理费、担保费等费用，具体收费标准、支付方式等以借款当日丙方平台实施的相关收费细则为准。", Msyh8)));
            content13.Add(contentComment13);
            myDocument.Add(content13);
