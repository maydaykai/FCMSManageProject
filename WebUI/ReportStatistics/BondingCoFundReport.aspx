<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BondingCoFundReport.aspx.cs" Inherits="WebUI.ReportStatistics.BondingCoFundReport" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            //数据源
            var source = {
                url: '/HanderAshx/ReportStatistics/BondingCoFundReportHandler.ashx',
                cache: false,
                datatype: "json",
                root: 'Rows',
                datafields: [
            ...
            $("#btnOutput").click(function () {
                ...
                data.endDate = $("#txtEndDate").val() || "";
                formatedData = buildQueryString(data);
                window.open("/HanderAshx/ReportStatistics/BondingCoFundReportHandler.ashx?output=1&" + formatedData, "_blank");
            });
        });
    </script>
</head>
