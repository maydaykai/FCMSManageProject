<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CashTotal.aspx.cs" Inherits="WebUI.ReportStatistics.CashTotal" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            //数据源
            var source = {
                url: '/HanderAshx/ReportStatistics/CashTotalHandler.ashx',
                cache: false,
                datatype: "json",
                root: 'Rows',
                datafields: [
                    ...
                    { name: 'WithdrawCash', type: 'number' },
                    { name: 'CurrentPeriod', type: 'number' },
                    { name: 'DayBalance', type: 'number' }
            ...
            $("#jqxgrid").jqxGrid({
                ...
                columns: [
                    { dataField: 'TotalDate', text: '统计日期', width: 160, cellsalign: 'center', align: 'center', cellsformat: "yyyy-MM-dd" },
                    { dataField: 'OpeningBalance', text: '期初余额', width: 160, cellsalign: 'center', align: 'center',cellsformat: "F2" },
                    { dataField: 'RechargeAmount', text: '充值', width: 160, cellsalign: 'center', align: 'center',cellsformat: "F2", aggregates: ['sum'] },
                    { dataField: 'WithdrawCash', text: '提现', width: 160, cellsalign: 'center', align: 'center',cellsformat: "F2", aggregates: ['sum'] },
                    { dataField: 'CurrentPeriod', text: '余额', width: 160, cellsalign: 'center', align: 'center',cellsformat: "F2" },
                    { dataField: 'DayBalance', text: '当日会员余额', width: 160, cellsalign: 'center', align: 'center',cellsformat: "F2" }
                ]
            });
