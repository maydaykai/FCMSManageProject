<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ForumList.aspx.cs" Inherits="WebUI.Information.ForumList" %>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            var linkrenderer = function (row, column, value) {
                var parm = "/Information/EditForum.aspx?" + column + "=" + value + "&columnId=<%=ColumnId%>";
            ...
            $("#jqxgrid").jqxGrid({
                ...
                renderstatusbar: function (statusbar) {
                    ...
                    addButton.click(function (event) {
                        location.href = '/Information/EditForum.aspx?columnId=<%=ColumnId%>';
                    });
                },
            });
