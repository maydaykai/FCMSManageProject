<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditForum.aspx.cs" Inherits="WebUI.Information.EditForum" ValidateRequest="false" EnableEventValidation="false" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table cellpadding="0" cellspacing="0" class="editTable" border="0" style="min-width: 800px;">
                ...
                <tr>
                    ...
                    <td style="text-align: left; padding-left: 5px;">
                        <div style="float: left; margin-bottom: -3px;" class="selectDiv">
                            ...
                            <select id="selSections" name="selSections" disabled="disabled" runat="server"></select>
                ...
                <!--标题分类-->
                <tr>
                    <td style="text-align: right;">论坛模块：</td>
                    <td style="text-align: left; padding-left: 5px;">
                        <div style="float: left; margin-bottom: -3px;" class="selectDiv">
                            <span class="fl">
                                <img src="../images/input_left.png" style="width: 4px; height: 29px;" alt="" />
                            </span>
                            <select id="select_lt" name="selSections" runat="server">
                                <option value="http://bbs.rjb777.com/forum.php?mod=forumdisplay&fid=2">平台资讯</option>
                                <option value="http://bbs.rjb777.com/forum.php?mod=forumdisplay&fid=51">项目报告</option>
                                <option value="http://bbs.rjb777.com/forum.php?mod=forumdisplay&fid=37">运营数据报告</option>
                                <option value="http://bbs.rjb777.com/forum.php?mod=forumdisplay&fid=49">理财分享</option>
                                <option value="http://bbs.rjb777.com/forum.php?mod=forumdisplay&fid=48">新手入门</option>
                                <option value="http://bbs.rjb777.com/forum.php?mod=forumdisplay&fid=50">行业资讯</option>
                                <option value="http://bbs.rjb777.com/forum.php?mod=forumdisplay&fid=40">生活杂谈</option>
                                <option value="http://bbs.rjb777.com/forum.php?mod=forumdisplay&fid=44">建议反馈</option>
                                <option value="http://bbs.rjb777.com/forum.php?mod=forumdisplay&fid=47">投资疑问</option>
                                <option value="http://bbs.rjb777.com/forum.php?mod=forumdisplay&fid=52">活动专区</option>
                                
                               
                            </select>
                            <span class="fl" style="margin-left: -5px; cursor: pointer;">
                                <img src="../images/select_right.png" width="31" height="29" alt="" id="img_select_lt" />
                            </span>
                        </div>
                    </td>
                </tr>
                ...
                <tr runat="server" id="SourceId" >
                    <td style="text-align: right;">文章连接地址：</td>
                    <td style="text-align: left; padding-left: 5px;">
                        <div style="float: left; margin-bottom: -3px;">
                            <span class="fl">
                                <img src="../images/input_left.png" style="width: 4px; height: 29px;" alt="" />
                ...
                <tr>
                    <td style="text-align: right;display:none">资讯图片：</td>
                    <td style="text-align: left; padding-left: 5px; display: none" runat="server">
                ...
                <tr>
                    ...
                    <td style="text-align: left; padding-left: 5px;">
                        ...
                        <asp:Button ID="btnSave1" runat="server" Text="提交" CssClass="inputButton" OnClick="btnSave_ServerClick" />&nbsp;&nbsp;
                      <%--  <input type="button" class="inputButton" value="返回" onclick="location.href = 'InformationManage.aspx?columnId=<%=ColumnId%>';" />--%>
                    </td>
                </tr>
            </table>
        </div>
