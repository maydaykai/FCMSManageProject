<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MediaTypeManage.aspx.cs" Inherits="WebUI.Information.MediaTypeManage" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script src="/js/jqwidgets-ver3.1.0/jqwidgets/jqxgrid.selection.js"  type="text/javascript"></script>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#link_one").click(function () {
                window.location.href = '/Information/MediaTypeEdit.aspx?columnId=<%=ColumnId%>';
            });
            ...
            //数据源
            var source = {
                url: '/HanderAshx/Information/MediaTypeHandler.ashx',
                cache: false,
                datatype: "json",
                root: 'Rows',
                datafields: [
                    ...
                    { name: 'LogUrl', type: 'string' },
                    { name: 'LogUrlName', type: 'string' }
            ...
            var linkrenderer = function (row, column, value) {
                var parm = "/Information/MediaTypeEdit.aspx?" + column + "=" + value + "&columnId=<%=ColumnId%>";
            ...
            //var imagehtml = function (row, colum, value) {
            //    var temp = parseInt(value);
            //    var html = "<div style=\"text-overflow: ellipsis; overflow: hidden; padding-bottom: 2px; text-align: center; margin-top: 5px;\">";
            //    html += "<img class=\"fl imgS\" src=\"" + value + "\" style=\"margin: 3px 3px 6px 0px; display: inline-block;\"   />";
            //    html += "</div>";
            //    return html;
            //}

            var imagerenderer = function (row, datafield, value) {
                return '<img style="margin-left: 5px;" height="100" width="150" src="' + value + '"/>';
            }
            ...
            $("#jqxgrid").jqxGrid({
                ...
                columns: [
                    ...
                    { dataField: 'LogUrl', text: '<b>图片</b>', width: 200, cellsalign: 'center', align: 'center', cellsrenderer: imagerenderer }
                ],
                showstatusbar: true,
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="fl" style="margin-left:5px;">
         ...
         <div id="add"><div style='overflow: hidden; position: relative; margin: 5px;'></div>
                <div style='float: left; margin-left: 5px;'>
                    <span style='margin-left: 4px; position: relative; top: -3px;'>
                       <input type="button" id="link_one"  class="inputButton" value="增加" /> 
