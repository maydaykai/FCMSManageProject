<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReturnCashFeeAdd.aspx.cs" Inherits="WebUI.FinanceSettlement.ReturnCashFeeAdd" %>
    ...
    <script type="text/javascript">
        $(function () {
            $("input[name=btnBack]").click(function () {
                window.location.href = "ReturnCashFeeManage.aspx?columnId=<%=ColumnId%>";
            });
        });
    </script>
</head>
<body>
    <form id="form1" runat="server">
        <table cellpadding="0" cellspacing="0" class="editTable">
            <tr>
                ...
                <td style="text-align: left; padding-left: 5px; padding-top: 5px;">
                    <div style="float: left; margin-bottom: -3px;">
                        ...
                        <span class="fl" style="line-height: 29px; color: #dc143c;">&nbsp;&nbsp;需要发放奖励的会员。</span>
                    </div>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td style="text-align: right">奖励描述：</td>
                <td style="text-align: left; padding-left: 5px; padding-top: 5px;">
                    <div style="float: left; margin-bottom: -3px;">
                        <span class="fl">
                            <img src="../images/<%=(Id>0?"gray_left.png":"input_left.png") %>" style="width: 4px; height: 29px;" alt="" />
                        </span>
                        <input id="txtDescription" type="text" name="txtDescription" value="" class="input_text fl" maxlength="10" style="width: 120px;" runat="server" />
                        <span class="fl">
                            <img src="../images/<%=(Id>0?"gray_right.png":"input_right.png") %>" style="width: 4px; height: 29px;" alt="" />
                        </span>
                        <span class="fl" style="line-height: 29px; color: #dc143c;">&nbsp;&nbsp;涉及到短信模板，控制在6个字为佳。</span>
                    </div>
                </td>
            </tr>
