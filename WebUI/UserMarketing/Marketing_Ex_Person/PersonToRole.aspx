<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PersonToRole.aspx.cs" Inherits="WebUI.UserMarketing.Marketing_Ex_Person.PersonToRole" %>
...
<head id="Head1" runat="server">
    <title></title>
   <%-- <script src="../../js/jqwidgets-ver3.1.0/jqwidgets/jqxbuttons.js"></script>--%>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            //数据源
            var source = {
                url: '/HanderAshx/UserMarketing/RoleNameToPersonHandler.ashx',
                cache: false,
                datatype: "json",
                root: 'Rows',
                datafields: [
            ...
            var linkrenderer = function (row, column, value) {
                ...
                var link = "<a href='DistributionPerson.aspx?" + parm + "'  target='_self' style='margin-left:10px;height:25px;line-height:25px;'>分配人员</a> ";
            ...
            $("#jqxgrid").jqxGrid({
                ...
                columns: [
                        { text: '<b>分配人员</b>', dataField: 'ID', width: 100, cellsalign: 'center', align: 'center', cellsrenderer: linkrenderer },
                        { text: '<b>所属部门</b>', dataField: 'PName', width: 120, cellsalign: 'center', align: 'center' },
                        { text: '<b>角色</b>', dataField: 'RoleName', width: 120, cellsalign: 'center', align: 'center' },
                        { text: '<b>等级</b>', dataField: 'Leave', width: 120, cellsalign: 'center', align: 'center' },
                        { text: '<b>状态</b>', dataField: 'Status', width: 120, cellsalign: 'center', align: 'center' }
