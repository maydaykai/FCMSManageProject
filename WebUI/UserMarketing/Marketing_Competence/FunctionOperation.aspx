<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FunctionOperation.aspx.cs" Inherits="WebUI.UserMarketing.Marketing_Competence.FunctionOperation" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            //数据源
            var source = {
                url: '/HanderAshx/UserMarketing/FunctionOperationHandler.ashx',
                cache: false,
                datatype: "json",
                root: 'Rows',
                datafields: [
            ...
            $("#jqxgrid").jqxGrid({
                ...
                renderstatusbar: function (statusbar) {
                    ...
                    addButton.click(function (event) {
                        window.location.href = "/UserMarketing/Marketing_Competence/EditFunctionOperation.aspx?columnId=<%=ColumnId%>";
                    });
                },
                showstatusbar: true,
                showtoolbar: true,
                ...
                columns: [
                        ...
                        { text: '<b>功能名称</b>', dataField: 'OperationName', width: 120, cellsalign: 'center', align: 'center' },
                        { text: '<b>操作代码</b>', dataField: 'OperationCode', width: 150, cellsalign: 'center', align: 'center' },
                        { text: '<b>备注</b>', dataField: 'Remake', width: 180 }
                ]
            });
