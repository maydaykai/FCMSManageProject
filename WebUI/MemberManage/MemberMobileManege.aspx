<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MemberMobileManege.aspx.cs" Inherits="WebUI.MemberManage.MemberMobileManege" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        $(function () {
            ...
            //数据源
            var source = {
                url: '/HanderAshx/MemberManage/MemberMobileHandler.ashx',
                cache: false,
                datatype: "json",
                root: 'Rows',
                datafields: [
                    ...
                    { name: 'OldMobile', type: 'string' },
                    { name: 'NewMobile', type: 'string' },
            ...
            var linkrenderer = function (row, column, value) {
                ...
                var content;
                if (data.AuditStatus == 2 || data.AuditStatus == -1) content = "查看";
                else content = "审核";
                var parm = "../MemberManage/MemberMobileAudit.aspx?" + column + "=" + value + "&columnId=<%=ColumnId %>";
            ...
            $("#jqxgrid").jqxGrid({
                ...
                columns: [
                    ...
                    { dataField: 'OldMobile', text: '<b>修改前号码</b>', width: 150, cellsalign: 'center', align: 'center' },
                    { dataField: 'NewMobile', text: '<b>修改后号码</b>', width: 150, cellsalign: 'center', align: 'center' },
                    { dataField: 'Remark', text: '<b>申请备注</b>', width: 200, cellsalign: 'center', align: 'center' },
                    { dataField: 'AuditStatusStr', text: '<b>审核状态</b>', width: 120, cellsalign: 'center', align: 'center' },
