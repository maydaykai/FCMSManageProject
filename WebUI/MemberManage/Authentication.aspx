<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Authentication.aspx.cs" Inherits="WebUI.MemberManage.Authentication" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            //数据源
            var source = {
                url: '/HanderAshx/MemberManage/IdentityAuthentHandler.ashx?flag=1',
                cache: false,
                datatype: "json",
                root: 'Rows',
                datafields: [
            ...
            var linkrenderer = function (row, column, value) {
                var parm = "/MemberManage/IdentityAuthentAudit.aspx?" + column + "=" + value + "&columnId=" +<%=ColumnId %> +"";
