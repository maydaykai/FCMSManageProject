<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OverdueManage.aspx.cs" Inherits="WebUI.p2p.OverdueManage" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            //数据源
            var source = {
                url: '/HanderAshx/p2p/OverdueManage.ashx',
                cache: false,
                datatype: "json",
                root: 'Rows',
                datafields: [
                ...
                formatdata: function (data) {
                    ...
                    data.OverDays = $("#txtOverDays").val() || "";
                    data.filter = " OverStatus=1 and status<2 ";
            ...
            var linkrenderer = function (row, column, value) {
                ...
                //var parm = "../p2p/AdvanceAudit.aspx?LoanID=" + data.LoanID + "&PeNumber=" + data.PeNumber + "&columnId=<%=ColumnId %>";
                //var link = "<a style='text-align:center;margin-left:25px;' href='javascript:void(0)' onclick=\"MessageWindow(500,450,'" + parm + "')\"; target='_self'>垫付</a>";
                //var html = link;
                //return html;
                //var parm = column + "=" + value + "&columnId=<%=ColumnId%>";
                //var parm = "LoanID=" + data.LoanID + "PeNumber=" + data.PeNumber + "&columnId=<%=ColumnId%>";
                //var link = "<a href='../p2p/LoanDelayedAudit.aspx?" + parm + "'  target='_self' style='margin-left:5px;height:25px;line-height:25px;'>垫付</a>";
                //var html = $.jqx.dataFormat.formatlink(link);
                //return html;
                var parm = column + "=" + value;
                var link = "<a href='../p2p/AdvanceAudit.aspx?" + parm + "&columnId=<%=ColumnId%>'  target='_self' style='margin-left:10px;'>垫付</a>";
                var html = $.jqx.dataFormat.formatlink(link);
                return html;
            };
            ...
            $("#jqxgrid").jqxGrid({
                ...
                columns: [
                    { dataField: 'LoanID', text: '<b>垫付</b>', width: 50, cellsrenderer: linkrenderer },
                    ...
                    { dataField: 'OverDays', text: '<b>逾期天数</b>', width: 100, cellsalign: 'center', align: 'center' },
...
<body>
    <div id="searchbar" class="selectDiv">
        ...
        <span class="fl">逾期天数大于：</span>
        <div class="fl">
            <img src="/images/input_left.png" width="4" height="29" alt="" />
        </div>
        <input type="text" class="input_text fl"  maxlength="20" style="width: 150px;" id="txtOverDays"  />
        <div class="fl">
            <img src="../images/input_right.png" style="width: 4px; height: 29px;" alt="" />
        </div>
