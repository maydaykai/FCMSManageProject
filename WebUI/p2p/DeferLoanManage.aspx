<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DeferLoanManage.aspx.cs" Inherits="WebUI.p2p.DeferLoanManage" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            //数据源
            var source = {
                url: '/HanderAshx/p2p/DeferLoan.ashx',
                cache: false,
                datatype: "json",
                root: 'Rows',
                datafields: [
                    ...
                    { name: 'ExtensionTerm', type: 'int' },
                    { name: 'ExtensionModeStr', type: 'string' },
                    { name: 'ExtensionReason', type: 'string' },
            ...
            var linkrenderer = function (row, column, value) {
                ...
                var parm = "/p2p/DeferLoanAudit.aspx?" + column + "=" + value + "&columnId="+<%=ColumnId %>;
                var link = "<a style='text-align:center;margin-left:25px;' href='"+parm+"' target='_self'>审核</a>";
                var html = link;
                return html;
            };
            ...
            $("#jqxgrid").jqxGrid({
                ...
                columns: [
                    ...
                    { dataField: 'ExtensionTerm', text: '<b>申请期限</b>', width: 100, cellsalign: 'center', align: 'center' },
                    { dataField: 'ExtensionReason', text: '<b>申请原因</b>', width: 200, cellsalign: 'right', align: 'center'},
                    ...
                    { dataField: 'Remark', text: '<b>审核说明</b>', width: 150, cellsalign: 'right', align: 'center'},
                    { dataField: 'AuditRecords', text: '<b>审核记录</b>', width: 250, cellsalign: 'right', align: 'center'}
                ]
            });
        });
    </script>
