<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LoanManage.aspx.cs" Inherits="WebUI.p2p.LoanManage" %>
        ...
        $(document).ready(function () {
            ...
            $("#jqxgrid").jqxGrid({
                ...
                columns: [
                        ...
                        //{ text: '<b>到期日</b>', dataField: 'RepaymentLastTime', width: 180, cellsformat: "yyyy-MM-dd HH:mm:ss", cellsalign: 'center', align: 'center' }
                ]
            });
