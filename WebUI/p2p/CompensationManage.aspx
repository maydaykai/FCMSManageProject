<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CompensationManage.aspx.cs" Inherits="WebUI.p2p.CompensationManage" %>
        ...
        $(function () {
            ...
            $("#jqxgrid").jqxGrid({
                ...
                columns: [
                    ...
                    { dataField: 'RePrincipal', text: '<b>应还本金(元)</b>', width: 150, cellsalign: 'right', align: 'center', cellsformat: "F2" },
                    { dataField: 'ReInterest', text: '<b>应还利息(元)</b>', width: 150, cellsalign: 'right', align: 'center', cellsformat: "F2" },
                    { dataField: 'ReOverInterest', text: '<b>应还逾期利息(元)</b>', width: 150, cellsalign: 'right', align: 'center', cellsformat: "F2" },
                    { dataField: 'SurPrincipal', text: '<b>未还本金(元)</b>', width: 150, cellsalign: 'right', align: 'center', cellsformat: "F2" },
                    { dataField: 'SurReInterest', text: '<b>未还利息(元)</b>', width: 150, cellsalign: 'right', align: 'center', cellsformat: "F2" },
                    { dataField: 'SurOverInterest', text: '<b>未还逾期利息(元)</b>', width: 150, cellsalign: 'right', align: 'center', cellsformat: "F2" },
