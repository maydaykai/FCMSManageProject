...
{
    /// <summary>
    /// MemberDCollectionHandler 的摘要说明
    /// </summary>
    public class MemberDCollectionHandler : IHttpHandler
    {
        ...
        public object GetPageList(int currentPage, int pageSize, string filter)
        {
            ...
            var dt = memberBll.MemberDataCollection(currentPage, pageSize, filter, out total);
