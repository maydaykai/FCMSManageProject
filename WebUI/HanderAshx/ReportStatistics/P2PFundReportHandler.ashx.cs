...
{
    /// <summary>
    /// P2PFundReportHandler 的摘要说明
    /// </summary>
    public class P2PFundReportHandler : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            if (!string.IsNullOrEmpty(_output))
            {
                ...
                context.Response.AddHeader("Content-Disposition", "attachment;filename=P2PFundReport.xls");
        ...
        public object GetPageList(int pagenum, int pagesize, string sortField, string filter)
        {
            pagenum = pagenum + 1;
            int total;
            var dt = new FundRecordBll().GetFundFlow(-1, filter, pagenum, pagesize, sortField, out total);
        ...
        public HSSFWorkbook OutputSearchResult(string sortField, string filter)
        {
            ...
            ISheet sheet = hssfWorkbook.CreateSheet("平台资金流水");
